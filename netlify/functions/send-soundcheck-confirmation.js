...
exports.handler = async (event) => {
  ...
  const parentMsg = {
    to: parentEmail,
    from: FROM_EMAIL,
    subject: `${studentName} is registered for AngelStreet Sound Check!`,
    html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
      <div style="background:#ca3092;padding:24px;text-align:center;">
        ...
        <p style="color:rgba(255,255,255,0.8);margin:4px 0 0;font-size:14px;">AngelStreet Sound Check</p>
      </div>
      <div style="padding:24px;background:#fff;">
        ...
        <p style="color:#888;font-size:12px;margin-top:20px;">Questions? Email us at creativehub@angelstreetmemphis.com</p>
      </div>
  ...
  const adminMsg = {
    to: ADMIN_EMAILS,
    from: FROM_EMAIL,
    subject: `New Sound Check registration: ${studentName}`,
